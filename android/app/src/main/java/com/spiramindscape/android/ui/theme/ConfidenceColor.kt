...
private val ConfidenceLow = Color(0xFFFF725D)   // <= 4  (coral)
private val ConfidenceMid = Color(0xFFEBAF00)   // <= 7  (yellow)
private val ConfidenceHigh = Color(0xFF7EC5C4)  // > 7   (teal-green)
