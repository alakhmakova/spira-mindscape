        ...
        <div key={t.kind} className={`tcard tcard--${i}`}>
          ...
          <div className="tcard-main">
            ...
            <div className="tcard-bar">
              <span style={{ width: t.done ? "100%" : `${t.pct}%` }} />
            </div>
          </div>
        </div>
      ))}
      ...
      <div className="brand-body">
        <div className="brand-copy">
          <h1 className="brand-headline">
            The app that shows you the right direction to GROW
          </h1>
          <p className="brand-sub">
            Three kinds of targets. One clear path forward.
          </p>
        </div>
...
function LoginPage() {
  return (
    <>
      ...
      <div
        className="login-root brand-right"
        data-heading="serif"
        data-align="center"
      >
        <BrandPanel />
...
.login-root {
  ...
  --lp-radius: 10px;
  --lp-font-sans: GCentra, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif;
